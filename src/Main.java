...
public class Main
{
    public static void main(String[] args)
    {
        ...
        do
        {
            ...
            System.out.println("You rolled a " + die1 + " and, a " + die2 + " Which totals a" + total);
            if (total == 2 || total == 3 || total == 12)
            {
                System.out.println("You rolled a" + total + ", you crapped out!");
            }
            else if (total == 7 || total == 11) {
                System.out.println("You rolled a Nat" + total + ". You win!");
            }
            else
            {
                point = total;
